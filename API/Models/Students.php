...
use MVC\Model;
class ModelsStudents extends Model {
    ...
    public function Update($data,$id) {
        ...
        $query = $this->db->query("UPDATE " . DB_PREFIX . "students SET " . implode(', ', $cols) . " WHERE id=" . $id);
        $fdata = $this->lastrecord($id);
        return $fdata;
    }
    public function Delete($id) {
        $query = $this->db->query("DELETE FROM " . DB_PREFIX ."students WHERE id=".$id);
        return $id;
    }
}